...
# Grid
ttk.Label(root, text = 'Yellow', background = 'yellow').grid(row = 0, column = 0, stick=EW)
ttk.Label(root, text = 'Blue', background = 'Blue').grid(row = 0, column = 1, stick=EW)
ttk.Label(root, text = 'Green', background = 'Green').grid(row = 1, column = 0, stick=EW)
ttk.Label(root, text = 'Orange', background = 'Orange').grid(row = 1, column = 1, stick=EW)
